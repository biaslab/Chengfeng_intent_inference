...
#sample for training sub-lstm
import random
index_=range(len(data))
rate=0.9
slice = random.sample(index_, int(rate*len(data)))
# print(slice)
data=data[slice]
label=label[slice]
...
with tf.Session() as sess:
    ...
    while step * batch_size < training_iters:
        ...
        saver.save(sess, "/Users/jia/Documents/intent_inference/compare_model/model_elstm/lstm5/model.ckpt")
